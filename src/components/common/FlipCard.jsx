  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
            ...
            'overflow-hidden rounded-sm border border-zinc-900 bg-black',
        ...
        >
          ...
          />
          {/* Scrim: purely for text legibility over the photo, not decoration */}
        ...
        <div
          className={cn(
            ...
            'flex flex-col rounded-sm border border-zinc-900 bg-[#0A0A0A] p-6',
            'shadow-lg'
          )}
        >
      ...
      <button
        type="button"
        onClick={onSelect}
        className="absolute inset-0 z-20 h-full w-full cursor-pointer rounded-sm outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-black"
