    ...
    <main className="flex-1 py-16 bg-neutral-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <div className="text-xs font-extrabold text-nforce-red uppercase tracking-widest">Services & Solutions</div>
          ...
          {servicesList.map((service) => (
            <div key={service.id} className="bg-white rounded-xl border border-neutral-200 p-6 flex flex-col justify-between card-hover">
              <div className="space-y-4">
                <div className="w-12 h-12 rounded-lg bg-red-50 text-nforce-red flex items-center justify-center font-bold">
